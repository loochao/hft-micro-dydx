...
// OrderId Length
//
// The standard OrderId length is 9 symbols when generated at a rate of 1 OrderId per millisecond,
...
// (1/1/2016-1/1/2050) using the same worker OrderId within a single (although concurrent) application if
...
//  - provides stable OrderId Size over a long period at the rate of 1ms;
...
// Shortid type represents a short OrderId generator working with a given alphabet.
type Shortid struct {
	abc    Abc
	worker uint
...
// GetDefault retrieves the default short OrderId generator initialised with the default alphabet,
...
// GenerateShortId generates an OrderId using the default generator.
func GenerateShortId() (string, error) {
	return shortid.Generate()
}

// MustGenerateShortId acts just like GenerateShortId, but panics instead of returning errors.
...
// New constructs an instance of the short OrderId generator for the given worker number [0,31], alphabet
...
// GenerateShortId generates a new short OrderId.
...
// String returns a string representation of the short OrderId generator.
...
// Worker returns the value of worker for this short OrderId generator.
func (sid *Shortid) Worker() uint {
	return sid.worker
}

// NewAbc constructs a new instance of shuffled alphabet to be used for OrderId representation.
