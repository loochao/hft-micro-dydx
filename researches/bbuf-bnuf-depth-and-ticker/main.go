...
func main() {
	...
	if err == nil {
		err = ioutil.WriteFile("/home/clu/Projects/hft-micro/researches/bbuf-bnuf-depth-and-ticker/configs/longTD", longBytes, 0755)
		if err != nil {
			logger.Debugf("%v", err)
		}
	}
	...
	if err == nil {
		err = ioutil.WriteFile("/home/clu/Projects/hft-micro/researches/bbuf-bnuf-depth-and-ticker/configs/shortTD", shortBytes, 0755)
		if err != nil {
			logger.Debugf("%v", err)
		}
	}
