...
func main() {
	...
	cpuProfFile, err = os.Create("/home/clu/Projects/hft-micro/benchmarks/outputs/kcuf-depth5-ticker-ws.cpu.prof")
	if err != nil {
		panic(err)
	}
	...
	defer func(){
		...
		//runtime.GC()
		if heapProfFile, err = os.Create("/home/clu/Projects/hft-micro/benchmarks/outputs/kcuf-depth5-ticker-ws.heap.prof"); err != nil {
			panic(err)
