...
func init() {
	...
	_ = kucoin_usdtfuture.NewDepth5TickerWS(
		ctx, api,
...
func main() {
	...
	cpuProfFile, err = os.Create("/Users/chenjilin/Projects/hft-micro/benchmarks/outputs/kcuf-depth5-ticker-ws.cpu.prof")
	if err != nil {
		panic(err)
	}
	...
	defer func(){
		...
		//runtime.GC()
		if heapProfFile, err = os.Create("/Users/chenjilin/Projects/hft-micro/benchmarks/outputs/kcuf-depth5-ticker-ws.heap.prof"); err != nil {
			panic(err)
