...
func (w *BntsDepth5WS) readLoop(conn *websocket.Conn, channels map[string]chan *Message) {
...
func (w *BntsDepth5WS) readAll(r io.Reader) ([]byte, error) {
	b := make([]byte, 0, 512)
	for {
		if len(b) == cap(b) {
...
func (w *BntsDepth5WS) reconnect(ctx context.Context, wsUrl string, proxy string, counter int64) (*websocket.Conn, error) {
...
func (w *BntsDepth5WS) mainLoop(ctx context.Context, channels map[string]chan *Message, proxy string) {
...
func (w *BntsDepth5WS) heartbeatLoop(ctx context.Context, conn *websocket.Conn) {
...
func (w *BntsDepth5WS) Done() chan interface{} {
	return w.done
}

func NewBntsDepth5WS(
	ctx context.Context,
	proxy string,
