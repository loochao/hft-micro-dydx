...
func (w *OkusTickerWS) writeLoop(ctx context.Context, conn *websocket.Conn) {
...
func (w *OkusTickerWS) parseBinaryResponse(resp []byte) ([]byte, error) {
...
func (w *OkusTickerWS) findSymbol(msg []byte) string {
...
func (w *OkusTickerWS) readLoop(conn *websocket.Conn, channels map[string]chan *Message) {
...
func (w *OkusTickerWS) readAll(r io.Reader) ([]byte, error) {
	b := make([]byte, 0, 1024)
	for {
		if len(b) == cap(b) {
...
func (w *OkusTickerWS) reconnect(ctx context.Context, wsUrl string, proxy string, counter int64) (*websocket.Conn, error) {
...
func (w *OkusTickerWS) mainLoop(ctx context.Context, proxy string, channels map[string]chan *Message) {
...
func (w *OkusTickerWS) heartbeatLoop(ctx context.Context, conn *websocket.Conn, symbols []string) {
