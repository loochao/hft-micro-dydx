...
func (w *BncsDepth5WS) readLoop(conn *websocket.Conn, channels map[string]chan *Message) {
...
func (w *BncsDepth5WS) readAll(r io.Reader) ([]byte, error) {
	b := make([]byte, 0, 512)
	for {
		if len(b) == cap(b) {
...
func (w *BncsDepth5WS) reconnect(ctx context.Context, wsUrl string, proxy string, counter int64) (*websocket.Conn, error) {
...
func (w *BncsDepth5WS) mainLoop(ctx context.Context, channels map[string]chan *Message, proxy string) {
...
func (w *BncsDepth5WS) heartbeatLoop(ctx context.Context, conn *websocket.Conn) {
...
func (w *BncsDepth5WS) Done() chan interface{} {
	return w.done
}

func NewBncsDepth5WS(
	ctx context.Context,
	proxy string,
