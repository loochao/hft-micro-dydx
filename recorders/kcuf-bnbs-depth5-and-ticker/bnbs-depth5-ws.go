...
func (w *BnbsDepth5WS) readLoop(conn *websocket.Conn, channels map[string]chan *Message) {
...
func (w *BnbsDepth5WS) readAll(r io.Reader) ([]byte, error) {
	b := make([]byte, 0, 512)
	for {
		if len(b) == cap(b) {
...
func (w *BnbsDepth5WS) reconnect(ctx context.Context, wsUrl string, proxy string, counter int64) (*websocket.Conn, error) {
...
func (w *BnbsDepth5WS) mainLoop(ctx context.Context, channels map[string]chan *Message, proxy string) {
...
func (w *BnbsDepth5WS) heartbeatLoop(ctx context.Context, conn *websocket.Conn) {
...
func (w *BnbsDepth5WS) Done() chan interface{} {
	return w.done
}

func NewBnbsDepth5WS(
	ctx context.Context,
	proxy string,
