...
func (w *HbufDepth20WS) writeLoop(ctx context.Context, conn *websocket.Conn, symbols []string) {
...
func (w *HbufDepth20WS) readLoop(ctx context.Context, conn *websocket.Conn, symbols []string, channels map[string]chan *Message) {
...
func (w *HbufDepth20WS) readAll(r io.Reader) ([]byte, error) {
	b := make([]byte, 0, 1024)
	for {
		if len(b) == cap(b) {
...
func (w *HbufDepth20WS) reconnect(ctx context.Context, wsUrl string, proxy string, counter int64) (*websocket.Conn, error) {
...
func (w *HbufDepth20WS) mainLoop(ctx context.Context, proxy string, channels map[string]chan *Message) {
...
func (w *HbufDepth20WS) heartbeatLoop(ctx context.Context, conn *websocket.Conn, symbols []string) {
...
func (w *HbufDepth20WS) Done() chan interface{} {
	return w.done
}

func NewHbufDepth20WS(
	ctx context.Context,
	proxy string,
