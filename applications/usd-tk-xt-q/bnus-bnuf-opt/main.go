...
func optBySymbol(xSymbol, ySymbol string, writer *common.InfluxWriter, measurement string) (map[string]Result, error) {
	...
	fileName := fmt.Sprintf("/home/clu/Downloads/20210820-20210926-%s-%s-24h0m0s-3s-25ms.gz", xSymbol, ySymbol)
...
func main() {
	...
	dataPath := "/home/clu/Projects/hft-micro/applications/usd-tk-xt-q/configs/bnus-bnuf-opt/"
