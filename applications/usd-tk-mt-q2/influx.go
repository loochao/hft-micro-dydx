	...
	for _, xSymbol := range xSymbols {
		...
		if strat.xPosition != nil &&
			...
			if strat.tdBidSpreadMiddle != 0 {
				...
				fields["tdBidSpreadMiddle"] = strat.tdBidSpreadMiddle
				fields["tdSpreadEnterOffset"] = strat.tdSpreadEnterOffset
				fields["tdSpreadLeaveOffset"] = strat.tdSpreadLeaveOffset
			}
			...
			if strat.spreadReady {
				...
				fields["askSpreadLast"] = strat.askSpreadLast
				fields["bidSpreadLast"] = strat.bidSpreadLast
				fields["askSpreadMedian"] = strat.askSpreadMedian
				fields["bidSpreadMedian"] = strat.bidSpreadMedian
