...
func startXYStrategy(
	...
	stats, err := stream_stats.NewXYMakerTakerStats(stream_stats.NewXYMakerTakerStatsParams{
		XSymbol:        xSymbol,
		YSymbol:        ySymbol,
		XExchange:      xExchange,
		YExchange:      yExchange,
		...
		XVolatilityTDLookback:    config.XVolatilityTDLookback,
		XVolatilityTDSubInterval: config.XVolatilityTDSubInterval,
		XVolatilityTDCompression: config.XVolatilityTDCompression,

		YVolatilityTDLookback:    config.YVolatilityTDLookback,
		YVolatilityTDSubInterval: config.YVolatilityTDSubInterval,
		YVolatilityTDCompression: config.YVolatilityTDCompression,
		...
		XVolatilityQuantile:  config.XVolatilityQuantile,
		YVolatilityQuantile:  config.YVolatilityQuantile,

		AskSpreadQuantileEnter: config.AskSpreadQuantileEnter,
		AskSpreadQuantileLeave: config.AskSpreadQuantileLeave,
		BidSpreadQuantileEnter: config.BidSpreadQuantileEnter,
		BidSpreadQuantileLeave: config.BidSpreadQuantileLeave,
	...
	strat = &XYStrategy{
		...
		bidSpreadTimedMedian: common.NewTimedMedian(config.SpreadLookback),
		askSpreadTimedMedian: common.NewTimedMedian(config.SpreadLookback),
		bidSpreadLast:        0,
		askSpreadLast:        0,
		bidSpreadMedian:      0,
		askSpreadMedian:      0,
