...
func (strat *XYStrategy) updateSpread() {
	...
	strat.bidSpreadLast = (strat.yTicker.GetBidPrice()*strat.yExchange.GetPriceFactor() - strat.xTicker.GetBidPrice()*strat.xExchange.GetPriceFactor()) / (strat.xTicker.GetBidPrice()*strat.xExchange.GetPriceFactor())
	strat.askSpreadLast = (strat.yTicker.GetAskPrice()*strat.yExchange.GetPriceFactor() - strat.xTicker.GetAskPrice()*strat.xExchange.GetPriceFactor()) / (strat.xTicker.GetAskPrice()*strat.xExchange.GetPriceFactor())

	strat.bidSpreadMedian = strat.bidSpreadTimedMedian.Insert(strat.spreadTickerTime, strat.bidSpreadLast)
	strat.askSpreadMedian = strat.askSpreadTimedMedian.Insert(strat.spreadTickerTime, strat.askSpreadLast)
