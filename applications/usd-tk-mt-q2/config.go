...
type Config struct {
	...
	XVolatilityTDLookback    time.Duration `yaml:"xVolatilityTDLookback"`
	XVolatilityTDSubInterval time.Duration `yaml:"xVolatilityTDSubInterval"`
	XVolatilityTDCompression uint32        `yaml:"xVolatilityTDCompression"`

	YVolatilityTDLookback    time.Duration `yaml:"yVolatilityTDLookback"`
	YVolatilityTDSubInterval time.Duration `yaml:"yVolatilityTDSubInterval"`
	YVolatilityTDCompression uint32        `yaml:"yVolatilityTDCompression"`
	...
	BidSpreadQuantileEnter float64 `yaml:"bidSpreadQuantileEnter"`
	BidSpreadQuantileLeave float64 `yaml:"bidSpreadQuantileLeave"`
	AskSpreadQuantileEnter float64 `yaml:"askSpreadQuantileEnter"`

	AskSpreadQuantileLeave float64 `yaml:"askSpreadQuantileLeave"`
	...
	XVolatilityQuantile float64 `yaml:"xVolatilityQuantile"`
	YVolatilityQuantile float64 `yaml:"yVolatilityQuantile"`
...
func (config *Config) SetDefaultIfNotSet() error {
	...
	if config.AskSpreadQuantileEnter == 0 {
		config.AskSpreadQuantileEnter = 0.005
	}
	if config.BidSpreadQuantileEnter == 0 {
		config.BidSpreadQuantileEnter = 0.995
	}
	if config.BidSpreadQuantileLeave == 0 {
		config.BidSpreadQuantileLeave = 0.2
	}
	if config.AskSpreadQuantileLeave == 0 {
		config.AskSpreadQuantileLeave = 0.8
	}
