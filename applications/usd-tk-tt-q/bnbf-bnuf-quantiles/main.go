...
func main() {
	...
	endTime, err := time.Parse("20060102", "20210820")
	if err != nil {
		logger.Fatal(err)
	}
	dateStrs := ""
	...
	quantilePath := "/home/clu/Projects/hft-micro/applications/usd-tk-tt-q/bnbf-bnuf-quantiles/outputs"
	dataPath := "/home/clu/Downloads/bnbf-bnuf-depth-and-ticker"
