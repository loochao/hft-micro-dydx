...
func main() {
	...
	endTime, err := time.Parse("20060102", "20210723")
	if err != nil {
		logger.Fatal(err)
	}
	dateStrs := ""
	...
	quantilePath := "/Users/chenjilin/Projects/hft-micro/applications/usd-md-mt-q/configs/bbuf-bnuf-quantiles"
	...
	for _, xSymbol := range symbols {
		...
		for _, dateStr := range strings.Split(dateStrs, ",") {
			...
			for scanner.Scan() {
				...
				if yTD != nil && xTD != nil && isXDepthReady {
