...
func (strat *XYStrategy) walkXDepth() {
	...
	strat.xWalkedDepth.BidPrice = strat.xWalkedDepth.BestBidPrice
...
func (strat *XYStrategy) walkYDepth() {
	...
	strat.error = common.WalkDepthBBMAA(strat.yDepth, strat.yMultiplier, *strat.takerImpact, &strat.yWalkedDepth)
	if strat.error != nil {
