...
var mtDepths = make(map[string]*common.WalkedTakerDepth)
...
var mtSignals = make(map[string]Signal)
var mtSignalCh = make(chan Signal, 100000)

var mtConfig *Config

func init() {

	logger.Debug("####  BUILD @ 20210427 16:16:52  ####")
