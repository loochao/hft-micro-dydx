...
func watchSpread(
	...
	for {
		...
		case lob := <-walkedOrderBookCh:
			...
			lastEnterSpread := (swapLob.TakerBidVWAP - spotLob.TakerAskVWAP) / spotLob.TakerAskVWAP
			lastExitSpread := (swapLob.TakerAskVWAP - spotLob.TakerBidVWAP) / spotLob.TakerBidVWAP
