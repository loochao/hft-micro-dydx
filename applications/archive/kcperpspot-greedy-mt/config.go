...
type Config struct {
	...
	SpotApiPassphrase *string `yaml:"spotApiPassphrase,omitempty"`

	PerpApiKey        *string `yaml:"perpApiKey,omitempty"`
	PerpApiSecret     *string `yaml:"perpApiSecret,omitempty"`
	PerpApiPassphrase *string `yaml:"perpApiPassphrase,omitempty"`
