...
var mAPI *huobi_usdtfuture.API
var tAPI *bnswap.API

var mUserWebsocket *huobi_usdtfuture.UserWebsocket
...
var mAccount *huobi_usdtfuture.Account
var mAccountCh = make(chan huobi_usdtfuture.Account, 10)
var mPositionCh = make(chan []huobi_usdtfuture.Position, 10)
var mBuyPositions = make(map[string]huobi_usdtfuture.Position)
var mSellPositions = make(map[string]huobi_usdtfuture.Position)
...
var mFundingRates map[string]huobi_usdtfuture.FundingRate
var mFundingRatesCh = make(chan map[string]huobi_usdtfuture.FundingRate, 10)
