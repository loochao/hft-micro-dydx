...
func main() {
	...
	case "binanceUsdtFutureWithDepth20":
		...
		break
	case "binanceBusdFutureWithDepth5":
		xExchange = &bnbf.BinanceBusdFutureWidthDepth5{}
		break
	case "binanceBusdFutureWithDepth20":
		xExchange = &bnbf.BinanceBusdFutureWidthDepth20{}
		break
	...
	case "binanceUsdtFutureWithDepth20":
		...
		break
	case "binanceBusdFutureWithDepth5":
		yExchange = &bnbf.BinanceBusdFutureWidthDepth5{}
		break
	case "binanceBusdFutureWithDepth20":
		yExchange = &bnbf.BinanceBusdFutureWidthDepth20{}
		break
	case "kucoinUsdtFutureWithDepth5":
