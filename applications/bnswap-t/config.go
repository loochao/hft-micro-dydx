...
type Config struct {
	...
	TradeMinCount          *int           `yaml:"tradeMinCount,omitempty"`
	TradeLookback          *time.Duration `yaml:"tradeLookback,omitempty"`
	Quantile               *float64       `yaml:"quantile,omitempty"`
	QuantileUpdateInterval *time.Duration `yaml:"quantileUpdateInterval,omitempty"`

	SymbolBatchSize  *int           `yaml:"symbolBatchSize,omitempty"`
	SignalTimeToLive *time.Duration `yaml:"signalTimeToLive,omitempty"`
