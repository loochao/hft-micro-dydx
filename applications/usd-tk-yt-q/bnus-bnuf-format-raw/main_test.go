...
func BenchmarkRead(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		func() {
			f, err := os.OpenFile("/home/clu/Downloads/20210910-20210915-1INCHUSDT-1INCHUSDT-24h0m0s-3s-1ms.gz", os.O_RDONLY, 0600)
			if err != nil {
				b.Fatal(err)
			}
...
func TestRead(t *testing.T) {
	f, err := os.OpenFile("/home/clu/Downloads/20210820-20210826-VETUSDT-VETUSDT-24h0m0s-3s-25ms.gz", os.O_RDONLY, 0600)
	//f, err := os.OpenFile("/home/clu/Downloads/20210820-20210916-VETUSDTM-VETUSDT-24h0m0s-3s-1ms.gz", os.O_RDONLY, 0600)
	if err != nil {
		t.Fatal(err)
	}
	defer f.Close()
