...
type Walked1000TickerWS struct {
...
func (w *Walked1000TickerWS) writeLoop(ctx context.Context, conn *websocket.Conn) {
...
func (w *Walked1000TickerWS) findMarket(msg []byte) (string, error) {
	collectStart := 0
	collectEnd := 94
	msgLen := len(msg)
...
func (w *Walked1000TickerWS) readLoop(conn *websocket.Conn, channels map[string]chan []byte) {
...
func (w *Walked1000TickerWS) readAll(r io.Reader) ([]byte, error) {
	b := make([]byte, 0, 1024)
	for {
		if len(b) == cap(b) {
			// Add more capacity (let append pick how much).
...
func (w *Walked1000TickerWS) reconnect(ctx context.Context, wsUrl string, proxy string, counter int64) (*websocket.Conn, error) {
...
func (w *Walked1000TickerWS) mainLoop(ctx context.Context, proxy string, channels map[string]chan []byte) {
...
func (w *Walked1000TickerWS) heartbeatLoop(ctx context.Context, conn *websocket.Conn, markets []string) {
...
func (w *Walked1000TickerWS) Stop() {
...
func (w *Walked1000TickerWS) restart() {
	select {
...
func (w *Walked1000TickerWS) Done() chan interface{} {
	return w.done
}

func (w *Walked1000TickerWS) dataHandleLoop(ctx context.Context, market string, inputCh chan []byte, outputCh chan common.Ticker) {
...
func NewWalked1000TickerWS(
	ctx context.Context,
	proxy string,
	channels map[string]chan common.Ticker,
) *Walked1000TickerWS {
	ws := Walked1000TickerWS{
