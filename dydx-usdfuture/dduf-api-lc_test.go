...
func TestAPI_GetLCAccounts(t *testing.T) {
	api, err := NewAPI(Credentials{
		ApiKey:        os.Getenv("DYDX_LC_KEY"),
		ApiSecret:     os.Getenv("DYDX_LC_SECRET"),
		ApiPassphrase: os.Getenv("DYDX_LC_PASSPHRASE"),
		AccountID:     os.Getenv("DYDX_LC_ACCOUNT_ID"),
	}, os.Getenv("DYDX_LC_PROXY"))
	if err != nil {
		t.Fatal(err)
	}
...
func TestAPI_GetLCAccount(t *testing.T) {
	api, err := NewAPI(Credentials{
		ApiKey:        os.Getenv("DYDX_LC_KEY"),
		ApiSecret:     os.Getenv("DYDX_LC_SECRET"),
		ApiPassphrase: os.Getenv("DYDX_LC_PASSPHRASE"),
...
func TestAPI_GetLCRewards(t *testing.T) {
	api, err := NewAPI(Credentials{
		ApiKey:        os.Getenv("DYDX_LC_KEY"),
		ApiSecret:     os.Getenv("DYDX_LC_SECRET"),
		ApiPassphrase: os.Getenv("DYDX_LC_PASSPHRASE"),
