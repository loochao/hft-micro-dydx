...
var InvalidPublicKeyError = errors.New("given x coordinate does not represent any point on the elliptic curve")
var Pi1024 = ``
...
var SYNTHETIC_ASSET_ID_MAP = map[string]*big.Int{}

func init() {
	// ------------ Asset IDs ------------
	COLLATERAL_ASSET_ID_BY_NETWORK_ID[NETWORK_ID_MAINNET], _ = ParseBig256("0x02893294412a4c8f915f75892b395ebbf6859ec246ec365c3b1f56f47c3a0a5d")
	COLLATERAL_ASSET_ID_BY_NETWORK_ID[NETWORK_ID_ROPSTEN], _ = ParseBig256("0x02c04d8b650f44092278a7cb1e1028c82025dff622db96c934b611b84cc8de5a")

	SYNTHETIC_ASSET_ID_MAP[ASSET_BTC], _ = ParseBig256("0x4254432d3130000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_ETH], _ = ParseBig256("0x4554482d3900000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_LINK], _ = ParseBig256("0x4c494e4b2d37000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_AAVE], _ = ParseBig256("0x414156452d38000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_UNI], _ = ParseBig256("0x554e492d3700000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_SUSHI], _ = ParseBig256("0x53555348492d370000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_SOL], _ = ParseBig256("0x534f4c2d3700000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_YFI], _ = ParseBig256("0x5946492d3130000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_ONEINCH], _ = ParseBig256("0x31494e43482d370000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_AVAX], _ = ParseBig256("0x415641582d37000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_SNX], _ = ParseBig256("0x534e582d3700000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_CRV], _ = ParseBig256("0x4352562d3600000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_UMA], _ = ParseBig256("0x554d412d3700000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_DOT], _ = ParseBig256("0x444f542d3700000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_DOGE], _ = ParseBig256("0x444f47452d35000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_MATIC], _ = ParseBig256("0x4d415449432d360000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_MKR], _ = ParseBig256("0x4d4b522d3900000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_FIL], _ = ParseBig256("0x46494c2d3700000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_ADA], _ = ParseBig256("0x4144412d3600000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_ATOM], _ = ParseBig256("0x41544f4d2d37000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_COMP], _ = ParseBig256("0x434f4d502d38000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_BCH], _ = ParseBig256("0x4243482d3800000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_LTC], _ = ParseBig256("0x4c54432d3800000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_EOS], _ = ParseBig256("0x454f532d3600000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_ALGO], _ = ParseBig256("0x414c474f2d36000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_ZRX], _ = ParseBig256("0x5a52582d3600000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_XMR], _ = ParseBig256("0x584d522d3800000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_ZEC], _ = ParseBig256("0x5a45432d3800000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_ENJ], _ = ParseBig256("0x454e4a2d3600000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_ETC], _ = ParseBig256("0x4554432d3700000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_XLM], _ = ParseBig256("0x584c4d2d3500000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_TRX], _ = ParseBig256("0x5452582d3400000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_XTZ], _ = ParseBig256("0x58545a2d3600000000000000000000")
	SYNTHETIC_ASSET_ID_MAP[ASSET_HNT], _ = ParseBig256("0x484e542d3700000000000000000000")
}
...
var ASSET_RESOLUTION = map[string]float64{
	ASSET_USDC:    1e6,
	ASSET_BTC:     1e10,
	ASSET_ETH:     1e9,
	ASSET_LINK:    1e7,
...
const (
	ORDER_FIELD_BIT_LENGTHS_NONCE = 32
...
var ORACLE_PRICE_FIELD_BIT_LENGTHS = map[string]uint{
	"asset_name":              128,
	"oracle_name":             40,
	"price":                   120,
