...
func ParseTrade(msg []byte) (*Trade, error) {
	//{"stream":"wavesusdt@trade","data":{"e":"trade","E":1620120764377,"s":"WAVESBUSD","t":23385964,"p":"37.84900000","q":"1.85300000","b":419242349,"a":419242185,"T":1620120764376,"m":false,"M":true}}
	var err error
	trade := Trade{}
	offset := 46
	collectStart := offset
