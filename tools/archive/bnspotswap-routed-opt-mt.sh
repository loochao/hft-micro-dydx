...
echo "$version"
sed -i "" -E "s/####.+####/#### $version ####/g" ./applications/bnspotswap-routed-usdt-mt/init.go


env GOOS=linux GOARCH=amd64 go build -o "./dist/hft-mirco-bnspotswap-routed-opt-mt.$dt" ./applications/bnspotswap-routed-usdt-mt
