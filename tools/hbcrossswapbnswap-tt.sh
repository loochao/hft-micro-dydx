...
echo "$version"
sed -i "" -E "s/####.+####/#### $version ####/g" ./applications/hbcrossswapbnswap-tt/init.go

env GOOS=linux GOARCH=amd64 go build -o "./dist/hft-mirco-hbcrossswapbnswap-tt.$dt" ./applications/hbcrossswapbnswap-tt
