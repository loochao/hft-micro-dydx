...
func (w *RawBookTickerWS) mainLoop(ctx context.Context, channels map[string]chan *common.RawMessage, proxy string) {
...
func (w *RawBookTickerWS) heartbeatLoop(ctx context.Context, conn *websocket.Conn) {
