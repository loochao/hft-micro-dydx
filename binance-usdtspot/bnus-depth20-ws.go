...
func (w *Depth20WS) mainLoop(ctx context.Context, channels map[string]chan []byte, proxy string) {
...
func (w *Depth20WS) heartbeatLoop(ctx context.Context, conn *websocket.Conn) {
