...
func (w *RawTradeWS) mainLoop(ctx context.Context, channels map[string]chan *common.RawMessage, proxy string) {
...
func (w *RawTradeWS) heartbeatLoop(ctx context.Context, conn *websocket.Conn) {
