...
func (bn *Bnmargin) IsSpot() bool {
	return true
}

func (bn *Bnmargin) StreamSymbolStatus(ctx context.Context, channels map[string]chan common.SymbolStatusMsg, batchSize int) {
	panic("implement me")
}

func (bn *Bnmargin) GenerateClientID() string {
	return fmt.Sprintf("%d%04d", time.Now().Unix(), rand.Intn(10000))
}

func (bn *Bnmargin) GetMinNotional(symbol string) (float64, error) {
...
func (bn *Bnmargin) GetMinSize(symbol string) (float64, error) {
...
func (bn *Bnmargin) GetStepSize(symbol string) (float64, error) {
...
func (bn *Bnmargin) GetTickSize(symbol string) (float64, error) {
...
func (bn *Bnmargin) StreamBasic(ctx context.Context, statusCh chan common.SystemStatus, accountCh chan common.Account, positionChMap map[string]chan common.Position, orderChMap map[string]chan common.Order) {
	defer bn.Stop()
	bn.mu.Lock()
...
func (bn *Bnmargin) StreamDepth(ctx context.Context, channels map[string]chan common.Depth, batchSize int) {
...
func (bn *Bnmargin) StreamTrade(ctx context.Context, channels map[string]chan common.Trade, batchSize int) {
...
func (bn *Bnmargin) StreamTicker(ctx context.Context, channels map[string]chan common.Ticker, batchSize int) {
	panic("implement me")
}

func (bn *Bnmargin) StreamKLine(ctx context.Context, channels map[string]chan []common.KLine, batchSize int, interval, lookback time.Duration) {
	panic("implement me")
}

func (bn *Bnmargin) StreamFundingRate(ctx context.Context, channels map[string]chan common.FundingRate, batchSize int) {
	bn.mu.Lock()
...
func (bn *Bnmargin) WatchOrders(ctx context.Context, requestChannels map[string]chan common.OrderRequest, responseChannels map[string]chan common.Order, errorChannels map[string]chan common.OrderError) {
	defer bn.Stop()
...
func (bn *Bnmargin) Setup(ctx context.Context, settings common.ExchangeSettings) (err error) {
...
func (bn *Bnmargin) Done() chan interface{} {
	return bn.done
}

func (bn *Bnmargin) watchSystemStatus(
	ctx context.Context,
...
func (bn *Bnmargin) submitOrder(ctx context.Context, param common.NewOrderParam, tickSize, stepSize float64, respCh chan common.Order, errCh chan common.OrderError) {
...
func (bn *Bnmargin) cancelOrder(ctx context.Context, param common.CancelOrderParam, errCh chan common.OrderError) {
	if param.Symbol != "" {
