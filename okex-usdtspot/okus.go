...
func (o *OkexUsdtSpot) Done() chan interface{} {
	panic("implement me")
}

func (o *OkexUsdtSpot) Stop() {
	panic("implement me")
}

func (o *OkexUsdtSpot) Setup(ctx context.Context, settings common.ExchangeSettings) error {
	panic("implement me")
}

func (o *OkexUsdtSpot) GetMinNotional(symbol string) (float64, error) {
	panic("implement me")
}

func (o *OkexUsdtSpot) GetMinSize(symbol string) (float64, error) {
	panic("implement me")
}

func (o *OkexUsdtSpot) GetStepSize(symbol string) (float64, error) {
	panic("implement me")
}

func (o *OkexUsdtSpot) GetTickSize(symbol string) (float64, error) {
	panic("implement me")
}

func (o *OkexUsdtSpot) GetMultiplier(symbol string) (float64, error) {
	panic("implement me")
}

func (o *OkexUsdtSpot) StreamBasic(ctx context.Context, statusCh chan common.SystemStatus, balanceChMap map[string]chan common.Balance, positionChMap map[string]chan common.Position, orderCh map[string]chan common.Order) {
	panic("implement me")
}

func (o *OkexUsdtSpot) StreamSymbolStatus(ctx context.Context, channels map[string]chan common.SymbolStatusMsg, batchSize int) {
	panic("implement me")
}

func (o *OkexUsdtSpot) StreamDepth(ctx context.Context, channels map[string]chan common.Depth, batchSize int) {
	panic("implement me")
}

func (o *OkexUsdtSpot) StreamTrade(ctx context.Context, channels map[string]chan common.Trade, batchSize int) {
	panic("implement me")
}

func (o *OkexUsdtSpot) StreamTicker(ctx context.Context, channels map[string]chan common.Ticker, batchSize int) {
	panic("implement me")
}

func (o *OkexUsdtSpot) StreamKLine(ctx context.Context, channels map[string]chan []common.KLine, batchSize int, interval, lookback time.Duration) {
	panic("implement me")
}

func (o *OkexUsdtSpot) StreamFundingRate(ctx context.Context, channels map[string]chan common.FundingRate, batchSize int) {
	panic("implement me")
}

func (o *OkexUsdtSpot) WatchOrders(ctx context.Context, requestChannels map[string]chan common.OrderRequest, responseChannels map[string]chan common.Order, errorChannels map[string]chan common.OrderError) {
	panic("implement me")
}

func (o *OkexUsdtSpot) GenerateClientID() string {
	panic("implement me")
}

func (o *OkexUsdtSpot) IsSpot() bool {
	return true
}
